...
class Console
{
     ...
     * @throws Exception
     */
    public static function loop(callable $callback, int $sleep = 1 /* seconds */, callable $onError = null): void
    {
        gc_enable();
        ...
        while (!connection_aborted() || PHP_SAPI === "cli") {
            ...
            if ((PHP_SAPI === "cli") && $time >= 60 * 5) { // Every 5 minutes
                $time = 0;
